...
function CommandDialog({
  ...
  /**
   * Forwarded to cmdk. Pass `false` when the caller has already ranked and
   * ordered the items itself: cmdk's own fuzzy filter would otherwise re-rank
   * and hide rows behind the caller's back.
   */
