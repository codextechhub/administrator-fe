      ...
      >
        <PopoverTrigger asChild={asChild}>
          <Button
            ...
            disabled={disabled}
            className={cn(
              "flex p-1 rounded-md bg-white text-gray-02 border border-border hover:bg-white hover:border-primary focus-visible:border-primary/60 min-h-10.5 h-auto items-center justify-between [&_svg]:pointer-events-auto shadow-none",
          ...
          >
            {selectedValues.length > 0 ? (
                      ...
                      return (
                        <Badge
                          ...
                          className={cn(
                            ...
                            "[&>svg]:pointer-events-auto text-xs",
                          )}
                          style={{
                            ...badgeStyle,
                            animationDuration: `${
              ...
              <div className="flex items-center justify-between w-full mx-auto">
                <span className="text-sm text-gray-02 mx-2">{placeholder}</span>
                <ChevronDown className="h-4 cursor-pointer text-gray-02 mx-2" />
              </div>
            )}
          </Button>
        </PopoverTrigger>
