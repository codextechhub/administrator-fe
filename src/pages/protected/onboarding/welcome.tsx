...
export default function OnboardingWelcome() {
  ...
  return (
    <main className="px-3 py-10 lg:px-10 flex justify-center">
      <div className="w-full max-w-140 flex flex-col gap-4">
        <div className="bg-white rounded-md px-6 py-8 sm:px-9">
          ...
          <div className="mt-6 flex items-center gap-3.5 rounded-md border border-border p-4">
            <div className="size-11 shrink-0 rounded-md bg-pry-01 text-primary grid place-content-center font-mont font-semibold text-sm">
